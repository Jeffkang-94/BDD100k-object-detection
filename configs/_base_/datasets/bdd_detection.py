...
data = dict(
    ...
    train=dict(
        type=dataset_type,
        ann_file=data_root + 'labels_coco/bdd100k_labels_images_daytime_train_coco.json',
        img_prefix=data_root + 'images/100k/train/',
        pipeline=train_pipeline),
    val=dict(
        type=dataset_type,
        ann_file=data_root + 'labels_coco/bdd100k_labels_images_daytime_val_coco.json',
        img_prefix=data_root + 'images/100k/val/',
        pipeline=test_pipeline),
    test=dict(
        type=dataset_type,
        ann_file=data_root + 'labels_coco/bdd100k_labels_images_night_val_coco.json',
        img_prefix=data_root + 'images/100k/val/',
        pipeline=test_pipeline))      
